...
describe('parseJUnit', () => {
  ...
  it('parses full Vitest example with multiple describes', () => {
    ...
    // multiply cases
    const multiplyNeg = result.testcases.find(t => t.subfolder === 'multiply' && t.title === 'deve lidar com números negativos');
    const findMaxNeg = result.testcases.find(t => t.subfolder === 'findMax' && t.title === 'deve lidar com números negativos');
